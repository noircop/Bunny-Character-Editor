...
2. Добавьте в script.rpy код из "2. Запуск Редактора"(Пункт Ниже)
3. Вызовите call open_character_editor
4. После вызова редактора  перед label start: объявите заранее:
        ```renpy
